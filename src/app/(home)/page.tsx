    ...
    <>
        <MaxWidthWrapper className='mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center'>
            ...
            <h1 className='max-w-4xl text-5xl font-bold md:text-6xl lg:text-7xl'>
                Beautiful <span className='text-blue-600'>Saas</span> in seconds.
            </h1>
            <p className='mt-5 max-w-prose text-zinc-700 sm:text-xl'>For all your SaaS needs for a basic landing page</p>
        ...
        {/*This is the value propostion section*/}
        <div>
        ...
        <div className=' mx-auto mb-32 mt-32 max-w-5xl sm:mt-56'>
            <div className='mb-12 px-6 lg:px-8'>
                <div className="mx-auto max-w-2xl sm:text-center">
                    <h2 className='mt-2 font-bold text-4xl text-gray-900 sm:text-5xl'>Start SaaSing in minutes</h2>
                    <p className='mt-4 text-lg text-gray-600'>Making a fully integrated SaaS app for your projects has never been easier than with this template.</p>
                </div>
            </div>
            ...
            <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
                ...
                <li className="md:flex-1">
                    <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
                        ...
                        <span className="mt-2 text-zinc-700">It&apos;s that simple. Try out SaaS today - it really takes less than a minute.</span>
                    </div>
                </li>
            </ol>

            {/*image for file upload can be any image*/}
            <div className='mx-auto max-w-6xl px-6 lg:px-8'>
                        <div className='mt-16 flow-root sm:mt-24'>
                            <div className='-m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4'>
                                <Image 
